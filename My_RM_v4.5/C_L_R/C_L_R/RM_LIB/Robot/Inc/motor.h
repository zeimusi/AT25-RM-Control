...
#define DM4310_LIMIT 20     //!<@brief DM4310������޷�(�������������Լ��Ͳ����ˣ����߷��)
...
typedef struct {
    ...
    uint8_t temp;                //!<@brief �¶�
    uint8_t PCBtemp;            //!<@brief PCB�¶�
    uint16_t LsatAngle;         //!<@brief ��һ�εĻ�е�Ƕ�
    int16_t r;                  //!<@brief Ȧ��
    int32_t Angle;              //!<@brief ��������е�Ƕ� @warning ��������ʱ�ǶȲ�ȷ��������ʱ�������Ƕȿ�����һȦ��ƫ��
    float Angle_DEG;            //!<@brief �������Ƕ��ƽǶ� @warning ��������ʱ�ǶȲ�ȷ��������ʱ�������Ƕȿ�����һȦ��ƫ��
    uint8_t flag;               //!<@brief ͳ��������е�Ƕȱ�־λ�����ڽ��һȦƫ������⣬�û�ʹ��ʱӦ���ԣ���Ҫ������и�ֵ
} DM4310_TypeDef;
