...
void usb_task(void *pvParameters)
{
    ...
    for(;;)
    {
        ...
        ROBOT_CMD_DATA.data.speed_vector_last.vx = ROBOT_CMD_DATA.data.speed_vector.vx;
        ROBOT_CMD_DATA.data.speed_vector_last.vy = ROBOT_CMD_DATA.data.speed_vector.vy;
        ROBOT_CMD_DATA.data.speed_vector_last.wz = ROBOT_CMD_DATA.data.speed_vector.wz;
