...
//extern float Gimbal_direct;
// uint16_t cnt = 0; // 启动频率计算延时
// uint8_t F_Change_flag = 0;
// int16_t T = 0; // 周期
// int16_t T_cnt =0; // 计数次数
// int16_t T_Time_cnt = 0; // 周期次数计算
// int16_t F_cnt = 0,F_cnt_last ; // 为F计数
// float F = 1;
/* USER CODE END PV */
...
//		if(F_Change_flag == 0)
//		{
//			Gimbal_direct = sin(2 * 3.1415f * T_cnt / T );
//			if(T_cnt >= T)
//			{
//				T_cnt = 0;
//				T_Time_cnt++;
...
void DMA2_Stream6_IRQHandler(void)
{
  ...
  /* USER CODE BEGIN DMA2_Stream6_IRQn 1 */
    ...
    __HAL_DMA_CLEAR_FLAG(&hdma_usart6_tx, DMA_FLAG_HTIF2_6);
    __HAL_DMA_CLEAR_FLAG(&hdma_usart6_tx, DMA_FLAG_TEIF2_6);
