...
#define MAX_TOPIC_COUNT 15    // 最多支持的话题数量
#define QUEUE_SIZE 1
 ...
 *
 * @param name 话题名称
 * @param typeSize 消息长度,通过sizeof()获取
 * @param length
