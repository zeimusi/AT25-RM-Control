...
#define PLUCK_SPEED 8500     //!< @brief 拨弹盘电机连发时速度环PID的期望值（弹频）
#define PLUCK_MOTOR_ONE 1360 //!< @brief 一发弹丸拨弹盘电机转过的机械角度

#define Pi 3.1415926535
#if RobotID == 0
/** @brief 不同ROBOT_ID不同参数 */
#define Yaw_Mid_Front 1170    //!< @brief Yaw轴电机机器人前方中值
#define Pitch_Mid 4256        //!< @brief Pitch轴电机云台水平值
#define P_ADD_limit 208	     //!< @brief Pitch轴电机上限位与水平位差值
#define P_LOSE_limit 165     //!< @brief Pitch轴电机下限位与水平位差值
#elif RobotID == 1
#define Yaw_Mid_Front 3150   //!< @brief Yaw轴电机机器人前方中值
#define Pitch_Mid 1455        //!< @brief Pitch轴电机云台水平值
#define P_ADD_limit 77	     //!< @brief Pitch轴电机上限位与水平位差值
#define P_LOSE_limit 37     //!< @brief Pitch轴电机下限位与水平位差值
