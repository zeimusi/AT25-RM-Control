...
void Gimbal_Task(){
     ...
     PID_init(&Gimbal_Place_pid_Yaw[INIT],25000,0,0,5,0,100,0,0,0,0,Integral_Limit);	
	   ...
	   PID_init(&Gimbal_Speed_pid_Pitch[INIT],25000,0,0,10,0,0,0,0,0,0,Integral_Limit );	
	   PID_init(&Gimbal_Place_pid_Pitch[INIT],25000,1000,0,15,0,0,0,0,0,0,Integral_Limit);
